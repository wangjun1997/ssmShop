...
<body>
    ...
    <div class="login">
       <div class="wrap">
	    ...
	    <ul class="breadcrumb breadcrumb__t"><a class="home" href="index.jsp">主页</a>  / 联系我们</ul>

		   <div class="content-top">
			   <form method="post" action="contact-post.jsp">
					<div class="to">
                     	<input type="text" class="text" value="您的名字" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '您的名字';}" style="border: 1px solid black">
					 	<input type="text" class="text" value="您的邮箱" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '您的邮箱';}" style="margin-left: 10px;border: 1px solid black">
					</div>
					<div class="to">
                     	<input type="text" class="text" value="您的电话" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '您的电话';}" style="border: 1px solid black">
					 	<input type="text" class="text" value="您的建议" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '您的建议';}" style="margin-left: 10px;border: 1px solid black">
					</div>
					<div class="text">
	                   <textarea value="建议内容" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '建议内容';}" style="border: 1px solid black">建议:</textarea>
	                </div>
	                <div class="submit">
